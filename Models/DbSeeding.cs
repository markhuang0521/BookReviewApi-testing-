...
namespace BookReview
{
    ...
    {
        public static void SeedDbContext (this  BookDbContext context)
        {
                ...
                var booksAuthors = new List<BookAuthor>()
            {
                new BookAuthor()
                {
                    Book = new Book()
                    {
                        ...
                        PulishTime = new DateTime(1903,1,1),
                ...
                new BookAuthor()
                {
                    Book = new Book()
                    {
                        ISBN = "1234",
                        Title = "Winnetou",
                        PulishTime = new DateTime(1878,10,1),
                        BookCategories = new List<BookCategory>()
                        {
                ...
                new BookAuthor()
                {
                    Book = new Book()
                    {
                        ...
                        PulishTime = new DateTime(2019,2,2),
                        BookCategories = new List<BookCategory>()
                        {
                ...
                new BookAuthor()
                {
                    Book = new Book()
                    {
                        ...
                        PulishTime = new DateTime(1879,3,2),
                        BookCategories = new List<BookCategory>()
                        {
